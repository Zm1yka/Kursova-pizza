    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex items-center justify-center p-6">
      <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
        <div>
          ...
          <p className="text-sm text-slate-500">Створіть акаунт або продовжіть через Google.</p>
        </div>
        ...
        <div className="text-sm text-slate-600">
          Вже є акаунт?{' '}
          <NavLink to="/login" className="text-emerald-700 hover:text-emerald-600 font-medium">
            Увійти
          </NavLink>
        </div>
